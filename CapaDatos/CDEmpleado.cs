...
namespace CapaDatos
{
    public class CDEmpleado
    {
        ...
        private string dNombre_Completo, dCedula, dGenero, dTelefono, dContacto_de_emergencia, dTipo_de_sangre, dNombre_Ars, dNumero_Afiliado_ARS, dCondiciones_medicas, dDireccion, dCargo, dNave;

        public CDEmpleado()
        {

        }
        public CDEmpleado(int pIdEmpleado, string pNombre_Completo, string pCedula, string pGenero, string pTelefono, string pContacto_de_emergencia, string pTipo_de_sangre, string pNombre_Ars, string pNumero_Afiliado_ARS, string pCondiciones_medicas, string pDireccion, string pCargo, string pNave)
        {

...
namespace CapaNegocio
{
    ...
    {
        public static string Insertar(int pIdEmpleado, string pNombre_Completo, string pCedula, string pGenero, string pTelefono, string pContacto_de_emergencia, string pTipo_de_sangre, string pNombre_Ars, string pNumero_Afiliado_ARS, string pCondiciones_medicas, string pDireccion, string pCargo, string pNave)
        {
        ...
        public static string Actualizar(int pIdEmpleado, string pNombre_Completo, string pCedula, string pGenero, string pTelefono, string pContacto_de_emergencia, string pTipo_de_sangre, string pNombre_Ars, string pNumero_Afiliado_ARS, string pCondiciones_medicas, string pDireccion, string pCargo, string pNave)
        {
            CDEmpleado objEmpleado = new CDEmpleado();
            objEmpleado.IdEmpleado = pIdEmpleado;
            objEmpleado.Nombre_Completo = pNombre_Completo;
